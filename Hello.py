...
diabetes_model = pickle.load(
    open("C:\\Users\\MANOHAR\\diabetes_model.sav", 'rb'))

heart_disease_model = pickle.load(
    open("C:\\Users\\MANOHAR\\heart_disease_model.sav", 'rb'))

parkinsons_model = pickle.load(
    open("C:\\Users\\MANOHAR\\parkinsons_model.sav", 'rb'))

breast_cancer_model = pickle.load(
    open("C:\\Users\\MANOHAR\\breast_cancer_model.sav", 'rb'))
